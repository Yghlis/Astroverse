...
// Créer un nouvel utilisateur depuis le site (inscription)
export const addUser = async (req, res) => {
  ...
  try {
    ...
    const newUser = await User.create({
      ...
      phone_number,
      address,
      roles: ['ROLE_USER'], // Utilisateurs créés depuis le site ont toujours le rôle 'ROLE_USER'
      isEmailVerified: true, // Email vérifié par défaut
      mustChangePassword: true // Doit changer le mot de passe par défaut
    }, { transaction });
...
export const updateUser = async (req, res) => {
  ...
  try {
    ...
    await user.update({
      ...
      roles,
      isEmailVerified,
      mustChangePassword: mustChangePassword !== undefined ? mustChangePassword : user.mustChangePassword, // Mettre à jour le champ mustChangePassword si fourni
    }, { transaction });
