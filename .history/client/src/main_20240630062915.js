...
import jwt_decode from 'jwt-decode'; // Assurez-vous que jwt-decode est correctement importé
import './style.css';
...
const token = localStorage.getItem('jwt');
if (token) {
    const decoded = jwt_decode(token); // Utiliser jwtDecode qui a été importé
