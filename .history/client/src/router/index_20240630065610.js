...
import * as jwtDecode from "jwt-decode"; // Utilisation de l'importation sans 'default'
...
const routes = [
  ...
  { path: "/change-password", name: "ChangePassword", component: ChangePassword, meta: { requiresAuth: true } }, // Nouvelle route pour changer le mot de passe
];
...
router.beforeEach((to, from, next) => {
  ...
  if (token) {
    try {
      const decoded = jwtDecode.default(token); // Utilisez la fonction importée correctement ici
