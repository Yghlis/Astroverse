          ...
          <div class="modal-body">
            <form @submit.prevent="onSubmit" enctype="multipart/form-data">
              <div v-if="currentDataType === 'products' && modalType === 'edit'">
                ...
                <input id="image_gallery_0" name="image_gallery[0]" type="file" @change="event => handleImageGalleryChange(event, 0)" accept="image/*" />
                <span>{{ errors.image_gallery && errors.image_gallery[0] }}</span>
  
                <label for="image_gallery_1">Image Gallery 2</label>
                <input id="image_gallery_1" name="image_gallery[1]" type="file" @change="event => handleImageGalleryChange(event, 1)" accept="image/*" />
                <span>{{ errors.image_gallery && errors.image_gallery[1] }}</span>
  
                <label for="image_gallery_2">Image Gallery 3</label>
                <input id="image_gallery_2" name="image_gallery[2]" type="file" @change="event => handleImageGalleryChange(event, 2)" accept="image/*" />
                <span>{{ errors.image_gallery && errors.image_gallery[2] }}</span>
  
                <label for="image_gallery_3">Image Gallery 4</label>
                <input id="image_gallery_3" name="image_gallery[3]" type="file" @change="event => handleImageGalleryChange(event, 3)" accept="image/*" />
