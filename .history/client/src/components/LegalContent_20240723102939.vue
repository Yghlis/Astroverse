<template>
    <div class="legal-content">
      ...
      <div v-if="section === 'legal'">
        ...
        <ul>
          ...
          <li>Email : <a href="mailto:Astroverse@gmail.com" target="_blank" class="url">Astroverse@gmail.com</a></li>
        </ul>
        ...
        <ul>
          ...
          <li>Email : <a href="mailto:Heroku@gmail.com" target="_blank" class="url">Heroku@gmail.com</a></li>
        </ul>
      </div>
  
      <div v-if="section === 'cgu'">
      ...
      <div v-if="section === 'privacy-policy'">
        <p><strong>1. Introduction</strong></p>
      ...
      <div v-if="section === 'refund-policy'">
        <p><strong>1. Introduction</strong></p>
      ...
      <div v-if="section === 'warranty-conditions'">
        <p>Votre contenu des conditions de garantie ici...</p>
      </div>
  
      <div v-if="section === 'cookie-policy'">
      ...
      <div v-if="section === 'shipping-policy'">
        <p><strong>1. Introduction</strong></p>
        ...
        <ul>
          <li>Si votre commande n'arrive pas dans les délais estimés, veuillez nous contacter via le formulaire de contact. Nous enquêterons sur la situation et vous tiendrons informé des prochaines étapes.</p>
        </ul>
      ...
      <div v-if="section === 'accessibility'">
      ...
      <div v-if="section === 'not-found'">
        <p>Le contenu que vous recherchez est introuvable.</p>
      </div>
    </div>
  </template>
  ...
  export default {
    ...
    watch: {
      '$route.params.section': 'updateContent'
    },
    methods: {
      updateContent() {
        ...
        switch (this.section) {
          ...
          case 'privacy-policy':
            ...
            break;
          case 'refund-policy':
            this.title = "Politique de remboursement";
            break;
          case 'warranty-conditions':
            this.title = "Conditions de garantie";
            break;
          case 'cookie-policy':
            this.title = "Politique de cookie";
            break;
          case 'shipping-policy':
            this.title = "Politique de livraison";
            break;
          case 'accessibility':
            this.title = "Accessibilité du site";
            break;
          default:
