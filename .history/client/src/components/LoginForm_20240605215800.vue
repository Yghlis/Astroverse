<template>
  <div>
    ...
    <form @submit.prevent="login">
      ...
      <button type="button" @click="goToForgotPassword" class="forgot-password">Mot de passe oublié?</button>
    </form>
...
export default {
  ...
  methods: {
    ...
    goToForgotPassword() {
      // Utilisez le routeur pour rediriger vers la page de réinitialisation du mot de passe
