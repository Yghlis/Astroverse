<template>
  <div class="reset-password-form" v-if="state.tokenValid">
    ...
    <div v-if="flashMessageActive" :class="`flash-message ${flashMessageType}`">{{ flashMessage }}</div>
...
const { flashMessage, flashMessageType, flashMessageActive, setFlashMessage } = useFlashMessageStore();
