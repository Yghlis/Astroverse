<template>
  <div>
    <div class="table-controls">
      ...
      <button @click="openCreateModal">Créer</button> <!-- Bouton Créer ajouté ici -->
    </div>
    <table>
      <thead>
        <tr>
...
import ModalConsult from '../ModalConsult.vue'; // Importation de la nouvelle modal
...
const showConsultModal = ref(false); // Nouvel état pour la modal de consultation
const modalType = ref('');
...
const openModal = (type, row) => {
  ...
  if (type === 'view') {
    showConsultModal.value = true; // Ouvrir la modal de consultation
  } else if (type === 'edit') {
...
const closeConsultModal = () => {
  showConsultModal.value = false; // Fermer la modal de consultation
};
</script>
