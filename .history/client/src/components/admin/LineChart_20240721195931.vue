<template>
  ...
  const getChartLabels = (timeframe) => {
    const labels = {
      last3Months: ["January", "February", "March", "April", "May", "June", "July"],
      last6Months: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
