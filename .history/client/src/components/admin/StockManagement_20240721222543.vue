      ...
      if (!isNaN(product.newStock) && Number.isInteger(product.newStock) && product.newStock >= 0) {
        ...
        try {
          ...
          const response = await fetch(`http://localhost:8000/products/${product.id}`, {
            ...
            body: JSON.stringify({
              title: product.name,
              brand: product.brand, // Assuming brand is part of the product object
              price: product.price, // Assuming price is part of the product object
              discounted_price: product.discounted_price, // Assuming discounted_price is part of the product object
              is_promotion: product.is_promotion, // Assuming is_promotion is part of the product object
              description: product.description, // Assuming description is part of the product object
              stock: product.newStock,
              character: product.character, // Assuming character is part of the product object
              universe: product.universe, // Assuming universe is part of the product object
              reference: product.reference,
              details: product.details, // Assuming details is part of the product object
              tags: product.tags, // Assuming tags is part of the product object
              availability_status: product.availability_status, // Assuming availability_status is part of the product object
              views_count: product.views_count, // Assuming views_count is part of the product object
              number_of_purchases: product.number_of_purchases, // Assuming number_of_purchases is part of the product object
              number_of_favorites: product.number_of_favorites, // Assuming number_of_favorites is part of the product object
              rating: product.rating // Assuming rating is part of the product object
            })
          });
