<template>
  ...
  const edit = (row) => {
    ...
    console.log('Editing Data:', editData.value); // Log to debug ID
    showEditModal.value = true;
  };
  
  const updateRow = async (updatedData) => {
    console.log('Updating Row:', updatedData); // Log to debug updated data
    ...
    try {
      ...
      console.error("Erreur lors de la mise à jour:",  console.log('URL:', url););
    }
  };
