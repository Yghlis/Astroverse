<template>
  ...
  const getChartLabels = (timeframe) => {
    const labels = {
      last3Months: ["August", "September", "October"],
      last6Months: ["May", "June", "July", "August", "September", "October"],
      lastYear: ["November", "December", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October"],
    };
