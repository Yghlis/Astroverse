<template>
  ...
  const getChartLabels = (timeframe) => {
    const labels = {
      ...
      currentMonth: Array.from({ length: 30 }, (_, i) => `Day ${i + 1}`),
      last3Months: ["Last Month 3", "Last Month 2", "Last Month 1"],
      last6Months: ["Month 1", "Month 2", "Month 3", "Month 4", "Month 5", "Month 6"],
      currentYear: ["January", "February", "March", "April", "May", "June", "July"],
