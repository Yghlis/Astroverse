            ...
            <div v-if="item">
              ...
              <div v-if="currentDataType === 'products'">
                ...
                <div>
                  ...
                  <img :src="transformUrl(item.image_preview)" alt="Image Preview" style="max-width: 200px;" v-if="item.image_preview" />
                </div>
                <div>
                  ...
                  <div v-for="(image, index) in item.image_gallery" :key="index" style="display: inline-block; margin-right: 10px;">
                    <img :src="transformUrl(image)" :alt="'Gallery Image ' + (index + 1)" style="max-width: 100px;" />
                  </div>
                </div>
              </div>
