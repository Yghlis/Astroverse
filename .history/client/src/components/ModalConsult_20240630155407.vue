          ...
          <div class="modal-body">
            <div v-if="item">
              ...
              <div v-if="currentDataType === 'users'">
                ...
                <p><strong>Numéro de téléphone :</strong> {{ item.phone_number }}</p>
                <p><strong>Rue :</strong> {{ item.address.street }}</p>
                <p><strong>Ville :</strong> {{ item.address.city }}</p>
                <p><strong>Code Postal :</strong> {{ item.address.postal_code }}</p>
                <p><strong>Pays :</strong> {{ item.address.country }}</p>
