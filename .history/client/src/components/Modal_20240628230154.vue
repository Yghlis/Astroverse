                ...
                <div class="modal-body">
                    <form @submit.prevent="onSubmit" enctype="multipart/form-data">
                        <div v-if="currentDataType === 'products' && modalType === 'edit'">
                            ...
                            <div v-if="formData.image_preview">
                                <img :src="formData.image_preview" alt="Image Preview" style="max-width: 200px;" />
                            </div>
                            ...
                            <div v-if="formData.image_gallery[0]">
                                <img :src="formData.image_gallery[0]" alt="Image Gallery 1" style="max-width: 200px;" />
                            </div>
                            ...
                            <div v-if="formData.image_gallery[1]">
                                <img :src="formData.image_gallery[1]" alt="Image Gallery 2" style="max-width: 200px;" />
                            </div>
                            ...
                            <div v-if="formData.image_gallery[2]">
                                <img :src="formData.image_gallery[2]" alt="Image Gallery 3" style="max-width: 200px;" />
                            </div>
                            ...
                            <div v-if="formData.image_gallery[3]">
                                <img :src="formData.image_gallery[3]" alt="Image Gallery 4" style="max-width: 200px;" />
                            </div>
...
console.log(formData.value); // Debug log
...
watch(() => props.selectedRow, (newRow) => {
    if (props.currentDataType === 'characters' && newRow) {
        ...
        tagsInput.value = formData.value.tags.join(', '); // Mise à jour du champ tags
        if (newRow.details) {
