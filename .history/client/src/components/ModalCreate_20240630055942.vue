          ...
          <div class="modal-body">
            <form @submit.prevent="onSubmit" enctype="multipart/form-data">
              ...
              <div v-if="currentDataType === 'users'">
                ...
                <label for="isEmailVerified">Email vérifié</label>
                <input id="isEmailVerified" v-model="formData.isEmailVerified" type="checkbox" />
                <span>{{ errors.isEmailVerified }}</span>
  
                <label for="mustChangePassword">Doit changer le mot de passe</label>
                <input id="mustChangePassword" v-model="formData.mustChangePassword" type="checkbox" />
                <span>{{ errors.mustChangePassword }}</span>
              </div>
