<template>
  ...
  const errors = computed(() => {
    if (props.currentDataType === 'universes') {
      return universeFormStore.errors;
    } else if (props.currentDataType === 'characters') {
      return characterFormStore.errors;
    } else if (props.currentDataType === 'products') {
      return productFormStore.errors;
    }
    return {};
  });
  ...
  const universes = computed(() => {
    if (props.currentDataType === 'characters' || props.currentDataType === 'products') {
