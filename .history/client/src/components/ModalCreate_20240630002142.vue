<template>
      ...
      <div class="modal-wrapper">
        <div class="modal-container" :style="{ width: width, height: height }">
          <div class="modal-header">
            <slot name="header">Créer un Produit</slot>
          </div>
  ...
  console.log('ModalCreate.vue setup script loaded!')
  ...
  const onSubmit = async () => {
    ...
    await productFormStore.handleCreate(); // Appelez la méthode handleCreate du store
  };
