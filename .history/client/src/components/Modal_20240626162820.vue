<template>
          ...
          <div class="modal-body">
            <form @submit.prevent="onSubmit">
              ...
              <div v-if="currentDataType === 'products' && modalType === 'edit'">
                ...
                <input id="is_promotion" v-model="formData.is_promotion" type="checkbox" @change="handlePromotionChange" />
  ...
  const handlePromotionChange = () => {
    if (!formData.value.is_promotion) {
      formData.value.discounted_price = null; // Reset discounted price when promotion is unchecked
    }
  };
