...
export const useProductFormStore = defineStore('productForm', () => {
  ...
  function setFormData(data) {
    ...
    const cleanUrl = (url) => {
      if (!url) return '';
      // Assurez-vous que l'URL ne commence pas par http://localhost:5173/
    ...
    Object.assign(formData, {
      ...
      image_preview: cleanUrl(data.image_preview),
      image_gallery: Array.isArray(data.image_gallery) ? data.image_gallery.map(cleanUrl) : ['', '', '', '']
    });
