...
export const useProductFormStore = defineStore('productForm', () => {
  ...
  function setFormData(data) {
    ...
    Object.assign(formData, {
        ...
        image_preview: data.image_preview ? `${window.location.origin}/${data.image_preview}` : '',
        image_gallery: Array.isArray(data.image_gallery) ? data.image_gallery.map(img => `${window.location.origin}/${img}`) : ['', '', '', '']
    });
