...
export const useProductFormStore = defineStore('productForm', () => {
  const initialData = {
    ...
    brand: '',
    price: 0,
    discounted_price: null,  // Set initial value to null
    is_promotion: false,
    description: '',
    stock: 0,
    image_preview: '',
  ...
  const schema = z.object({
    ...
    discounted_price: z.union([z.number().optional(), z.null()]),  // Allow null value
    ...
    tags: z.array(z.string()).optional()  // Change tags to be an array of strings
  });
