...
export const useProductFormStore = defineStore('productForm', () => {
  const initialData = {
    ...
    title: '',
    brand: '',
    price: '0',  // Initialisation en tant que chaîne de caractères
    discounted_price: '0',  // Initialisation en tant que chaîne de caractères
    is_promotion: false,
    description: '',
    stock: 0,
    image_preview: '',
  ...
  function setFormData(data) {
    ...
    Object.assign(formData, {
      ...data,
      price: data.price.toString(),  // Conversion en chaîne de caractères
      discounted_price: data.discounted_price.toString(),  // Conversion en chaîne de caractères
