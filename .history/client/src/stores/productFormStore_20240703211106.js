...
export const useProductFormStore = defineStore('productForm', () => {
  const initialData = {
    ...
    tags: '', // Notez que nous initialisons ici `tags` comme une chaîne vide
    image_preview_url: '',
    image_gallery_urls: ['', '', '', '']
  };
  ...
  function setFormData(data) {
    ...
    Object.assign(formData, {
      ...
      tags: Array.isArray(data.tags) ? data.tags.join(', ') : data.tags || '', // Convertir le tableau de tags en chaîne de caractères
