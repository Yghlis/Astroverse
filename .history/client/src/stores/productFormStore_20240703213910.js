...
export const useProductFormStore = defineStore('productForm', () => {
  ...
  function setFormData(data) {
    ...
    // Corriger les tags
    const parsedTags = Array.isArray(data.tags) ? data.tags.map(tag => tag.replace(/[\[\]"]/g, '').trim()) : [];
    ...
    Object.assign(formData, {
      ...
      tags: parsedTags.join(', '), // Convertir le tableau de tags en chaîne de caractères
