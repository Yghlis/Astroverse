...
export const useProductFormStore = defineStore('productForm', () => {
  ...
  function setFormData(data) {
    ...
    Object.assign(formData, {
      ...
      image_preview_url: data.image_preview ? `http://localhost:8000/uploads/${data.image_preview}` : '',
      image_gallery_urls: data.image_gallery ? data.image_gallery.map(file => `http://localhost:8000/uploads/${file}`) : ['', '', '', '']
    });
