    ...
    async function handleSubmit() {
        try {
          ...
          formData.image_gallery.forEach((file, index) => {
            if (document.querySelector(`input[name="image_gallery"]`).files[index]) {
              formDataToSend.append('image_gallery', document.querySelector(`input[name="image_gallery"]`).files[index]);
            }
          });
