...
export const useProductFormStore = defineStore('productForm', () => {
  const initialData = {
    ...
    title: '',
    brand: '',
    price: '0',  // Assurez-vous que ce sont des chaînes de caractères
    discounted_price: '0',  // Assurez-vous que ce sont des chaînes de caractères
    is_promotion: false,
    description: '',
    stock: 0,
    image_preview: '',
  ...
  function setFormData(data) {
    ...
    Object.assign(formData, {
      ...data,
      price: data.price.toString(),  // Assurez-vous que ce sont des chaînes de caractères
      discounted_price: data.discounted_price.toString(),  // Assurez-vous que ce sont des chaînes de caractères
  ...
  async function handleSubmit() {
    try {
      ...
      formData.price = parseFloat(formData.price.toString().replace(',', '.'));
      formData.discounted_price = formData.discounted_price ? parseFloat(formData.discounted_price.toString().replace(',', '.')) : 0;
