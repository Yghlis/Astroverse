...
export const getUserById = async (req, res) => {
    ...
    // On vérifie si l'utilisateur demande ses propres informations ou si c'est un admin car je ne sais pas si un utilisateur actuellement peut accéder aux données d'un autre
    if (id !== authenticatedUserId && !req.user.roles.includes('ROLE_ADMIN')) {
