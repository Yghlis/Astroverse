...
export const addUser = async (req, res) => {
  ...
  try {
    ...
    const newUser = await User.create({
      ...
      phone_number,
      address,
      roles: roles || ['ROLE_USER'], // Default role to 'ROLE_USER' if not provided
      isEmailVerified: isEmailVerified !== undefined ? isEmailVerified : true, // Default to true if not provided
      mustChangePassword: mustChangePassword !== undefined ? mustChangePassword : true, // Default to true if not provided
