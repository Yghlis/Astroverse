...
export const addUser = async (req, res) => {
  const { first_name, last_name, email, password_hash, phone_number, address, roles, isEmailVerified, mustChangePassword } = req.body;// valider la donnée
  ...
  try {
    ...
    // Ajout de logs pour vérifier l'utilisateur authentifié et son rôle
    console.log('Authenticated user:', req.user);

    // Si l'utilisateur authentifié a le rôle d'administrateur, isEmailVerified est défini sur true
    if (req.user && req.user.role === 'ROLE_ADMIN') {
      console.log('User is admin, setting isEmailVerified to true');
      ...
      console.log('User is not admin, email will not be verified automatically');
    }
