...
async function sendNotificationEmail(email) {
    const mailOptions = {
        ...
        text: 'Votre compte a été verrouillé après trois tentatives de connexion infructueuses. Veuillez essayer de nouveau après cinq minutes.'
    };
...
const postLogin = async (req, res) => {
    ...
    try {
        ...
        if (user.lastPasswordChange < sixtyDaysAgo) {
