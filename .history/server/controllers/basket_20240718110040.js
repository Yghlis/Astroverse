...
export const checkBasketItems = async (req, res) => {
  try {
    const sessionId = req.headers['session-id'];
    console.log('Received session ID:', sessionId);  // Log the session ID
    ...
    console.log('Basket found:', basket);  // Log the basket found
    ...
    console.log('Basket items:', basket.items);  // Log the items in the basket
