...
export const createOrder = async (req, res) => {
  ...
  try {
    ...
    const order = await Order.create({
      userId,
      firstName: user.first_name, // Utilisez les bonnes propriétés du modèle User
      lastName: user.last_name,   // Utilisez les bonnes propriétés du modèle User
      phoneNumber: user.phone_number, // Ajoutez le numéro de téléphone ici
      shippingAddress,
      billingAddress,
      products,
      tax,
