...
export const addProduct = async (req, res) => {
  ...
  const image_preview = req.files['image_preview'] ? req.files['image_preview'][0].path : null;
  const image_gallery = req.files['image_gallery'] ? req.files['image_gallery'].map(file => file.path) : [];
