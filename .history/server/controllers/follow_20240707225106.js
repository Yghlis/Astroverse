...
export const notifyProductChange = async (product) => {
  try {
    ...
    for (const follow of followers) {
      ...
      const previousStock = product.getDataValue('previous_stock');
      const currentStock = product.stock;
      const previousPromotion = product.getDataValue('previous_is_promotion');
      ...
      if (currentPromotion && !previousPromotion) {
