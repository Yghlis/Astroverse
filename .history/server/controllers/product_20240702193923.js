...
export const getProducts = async (filters) => {
  ...
  if (filters.priceRange && filters.priceRange.min !== undefined && filters.priceRange.max !== undefined) {
    ...
    query.$or = [
      { price: { $gte: filters.priceRange.min, $lte: filters.priceRange.max }, discounted_price: 0 },
      { discounted_price: { $gte: filters.priceRange.min, $lte: filters.priceRange.max }, is_promotion: true }
    ];
  }
