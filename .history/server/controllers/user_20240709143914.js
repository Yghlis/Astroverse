...
export const addUser = async (req, res) => {
  ...
  try {
    ...
    const newUserData = {
      ...
      isEmailVerified: true, // Par défaut, chaque nouvel utilisateur doit vérifier son email
      mustChangePassword: false, // Par défaut, chaque nouvel utilisateur n'a pas besoin de changer son mot de passe
      lastPasswordChange: new Date()
    };

    // Si l'utilisateur est authentifié et a le rôle d'administrateur, il peut définir des champs supplémentaires
