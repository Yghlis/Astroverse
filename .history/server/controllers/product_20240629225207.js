...
export const updateProduct = async (req, res) => {
  try {
    ...
    // Garder les anciennes images si aucune nouvelle image n'est téléchargée
    ...
    // Conserver les anciennes images de la galerie et mettre à jour seulement celles qui sont nouvelles
    let image_gallery = product.image_gallery.slice(); // Faire une copie de l'ancienne galerie d'images
    if (Array.isArray(req.files['image_gallery'])) {
