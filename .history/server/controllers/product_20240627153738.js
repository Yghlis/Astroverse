...
export const addProduct = async (req, res) => {
  try {
    console.log("addProduct appelé avec req.body:", req.body);
    console.log("addProduct appelé avec req.files:", req.files);
...
export const updateProduct = async (req, res) => {
  try {
    ...
    const { id } = req.params;
    if (!id) {
      return res.status(400).json({ error: 'ID du produit est requis' });
    }
