...
export const updateProduct = async (req, res) => {
  ...
  try {
    ...
    // Stocker les valeurs précédentes dans des variables temporaires
    const previousStock = product.stock;
    const previousPromotion = product.is_promotion;
    ...
    await notifyProductChange({ ...product.dataValues, previousStock, previousPromotion });
